...
$select=mysqli_query($conn, "SELECT * FROM templates");
...
<?php
	if($row>0)
		...
		echo'<div class="col-md-3" style="display:inline-block;">
			<div class="card">
			<a href="comment.php?vid='.$fetch['template_id'].'"><img class="card-img-top" style="height:15rem;" src="uploads/'.$fetch['image'].'"></a>
