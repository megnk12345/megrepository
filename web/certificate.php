...
$select=mysqli_query($conn, "SELECT * FROM certificates");
...
<?php
	if($row>0)
		...
		echo'<div class="col-md-4" style="display:inline-block;">
			<div class="card">
			<a href="comment.php?vid='.$fetch['certificate_id'].'"><img class="card-img-top" style="height:15rem;" src="uploads/'.$fetch['image'].'"></a>
